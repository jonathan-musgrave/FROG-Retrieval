function [Et_final, Gout, Gpout, Sout] = RANA_exp(I_FROG, time, G_cut, Gprime_cut ,noise_red, SNR_det) 
...
if noise_red
    ...
    [~, I_FROG_Mw] = noise_reduction(I_FROG);
end
...
[iter_array, tot_initial] = iteration_number_exp(N, SNR_det);    % total number of iterations and number of initial guesses based on the trace size
