...
4) Customize: To work with different system at your own lab, you will have to customize the FROG code according to your needs. Test_QuickFROG.m is a good start. In general, there are some important parameters you will have to know before running the algorithm. 
	...
	4.3) Core FROG Algorithm: different geometry: PG, SHG, TG, SFG, require different nonlinear-optical constraint. And therefore, please make sure you are using the correct constraint when you run the algorithm. 
	
Example: PG_XFROG

5) Automation: Working with loads of data could be time consuming. With the correct parameters in your hand, the FROG code could be customized to automate the retrieval process. 
